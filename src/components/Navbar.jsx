...
import skyeLogo from '../assets/skye.png'

function Navbar() {
  return (
    <nav className="border-b border-slate-200 bg-white/80 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        <Link to="/" className="flex items-center gap-1 text-slate-900">
          <img src={skyeLogo} alt="Skye logo" className="h-25 w-25 " />
          <span>
            <span className="block text-xl font-bold tracking-wide">Skye</span>
